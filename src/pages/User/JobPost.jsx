...
const JobPost = () => {
  ...
  const handlePost = async (e) => {
    ...
    const numberofdays=formElement.noofdays.value
          ...
          >
            <form style={{ width: "30rem" }} ref={formRef}>
              ...
              >
                ...
                <option value="Farming" style={{ backgroundColor: "#001524" }}>
                  Farming
                </option>
                <option
                  value="Carpenter"
                ...
                <option value="Painting" style={{ backgroundColor: "#001524" }}>
                  Painting
                </option>
                <option value="Welding" style={{ backgroundColor: "#001524" }}>
                  Welding
                </option>
                <option value="Mechanic" style={{ backgroundColor: "#001524" }}>
                  Mechanic
                </option>
                <option value="Driver" style={{ backgroundColor: "#001524" }}>
                  Driver
                </option>
                <option value="Catering" style={{ backgroundColor: "#001524" }}>
                  Catering
                </option>
                <option value="Plumbing" style={{ backgroundColor: "#001524" }}>
                  Plumbing
                </option>
                <option
                  value="Electriction"
                ...
                <option value="Others" style={{ backgroundColor: "#001524" }}>
                  Others
                </option>
              </Form.Select>
